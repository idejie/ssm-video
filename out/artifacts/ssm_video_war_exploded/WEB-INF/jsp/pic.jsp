                ...
                <div class="col-sm-12">
                    <form action="/v/${video.v_id}/add-pic/" method="post">
                        ...
                        <c:forEach items="${pics}" var ="pic">
                            <label class="custom-control custom-radio" style="margin-top: 40px;">
                                <input type="radio" name="pic"  class="custom-control-input" value="${pic}"><span class="custom-control-label"><img src="${pic}" ></span>
                            </label>
                        </c:forEach>
                    </div>
