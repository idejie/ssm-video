            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="card card-border-color card-border-color-primary">
                        <div class="card-header card-header-divider">修改密码<span class="card-subtitle"></span></div>
                        <div class="card-body">
                            <form>
                                <div class="form-group pt-2">
                                    <label for="oldpass">旧密码</label>
                                    <input id="oldpass" name="oldpass" type="password" placeholder="Old Password"
                                           class="form-control">
                                </div>
                                <div class="form-group">
                                    <label for="newpass">新密码</label>
                                    <input id="newpass" name="new pass" type="password" placeholder="New Password"
                                           class="form-control">
                                </div>
                                <div class="row pt-3">
                                    ...
                                    <div class="col-sm-6">
                                        <p class="text-right">
                                            <button type="submit" class="btn btn-space btn-primary">确认</button>
                                        </p>
                                    </div>
                                </div>
                            </form>
