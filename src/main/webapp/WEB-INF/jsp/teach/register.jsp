        ...
        <div class="main-content container-fluid">
            <div class="splash-container sign-up">
                <div class="card card-border-color card-border-color-primary">
                    ...
                    <div class="card-body">
                        <form action="/stu/register" method="post"><span class="splash-title pb-4">教师注册</span>
                            <div class="form-group">
                                <input type="text" name="t_id" id="t_id" required="" placeholder="工号" autocomplete="off"
                                       class="form-control">
                            </div>
                            <div class="form-group">
                                <input type="text" name="t_name" id="t_name" required="" placeholder="姓名"
