        ...
        <div class="main-content container-fluid">
            <div class="splash-container">
                <div class="card card-border-color card-border-color-primary">
                    <div class="card-header">教师登录<span class="splash-description">请输入你相关信息</span></div>
                    <div class="card-body">
                        <form action="/teach/login" method="post">
                            <div class="login-form">
                                <div class="form-group">
                                    <input id="t_id" name="t_id" type="text" placeholder="工号" autocomplete="off"
                                           class="form-control">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group row login-submit">
                                    <div class="col-6">
                                        <a data-dismiss="modal" href="/teach/register" class="btn btn-secondary btn-xl">注册</a>
                                    </div>
                                    <div class="col-6">
